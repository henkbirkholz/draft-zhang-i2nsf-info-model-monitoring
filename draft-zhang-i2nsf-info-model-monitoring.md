...
<!-- The mechanism provided by YANG Push {{-yangpush}} and YANG Subscribed Notifications {{-yangnote}} address exactly these set of requirements.
YANG also enables semantically well-structured information, as well as subscriptions to datatores or event streams - on-change or periodically. -->
